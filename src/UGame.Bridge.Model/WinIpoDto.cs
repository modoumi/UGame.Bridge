...
{
    public class WinIpo: IProviderWalletIpo, IProviderTransactionUUID, IProviderReferenceTransactionUUID, IProviderRound
    {
    ...
    public class WinDto: IProviderWalletDto
    {
        public string RequestUUID { get; set; }
        public string UserId { get; set; }
        public string CurrencyId { get; set; }
