...
using static UGame.Bridge.Sb.Controller.reSettle.SbReSettleIpo;
...
{
    internal class SbReSettleService : BaseActionService<SbReSettleIpo.SbReSettletxns, SbReSettleDto>
    {
        private List<S_provider_orderEO> _referBetOrderEos;
        protected override ProviderAction Action => ProviderAction.BetWin;
        public SbReSettleService(string providerId, SbReSettleIpo.SbReSettletxns ipo, string key) : base(providerId, ipo,key)
        {
        ...
        protected override async Task Execute(SbReSettleDto dto)
        {
